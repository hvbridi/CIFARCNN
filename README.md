...
- `Dropout` (which increased gradually per each layer), data augmentation and BatchNorm2d were used to avoid overfitting and ensure a robust model that can reliable predict the test data
